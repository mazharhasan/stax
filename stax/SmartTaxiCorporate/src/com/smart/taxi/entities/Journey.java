...
public class Journey extends BaseWebServiceEntity {
	...
	private String DriverInformation_name;
	...
	private void copy(Journey data) {
		...
		this.journey_users_pickup_lat = data.journey_users_pickup_door_address;
		this.journey_users_pickup_lng = data.journey_users_pickup_door_address;
		...
		this.journey_users_pickup_time = data.journey_users_dropOff_lng;
	...
	public String getDriverName() {
		return DriverInformation_name;
	}

	public void setDriverName(String driverInformation_name) {
		DriverInformation_name = driverInformation_name;
	}

	public void setCabProviderName(String providerName) {
		// TODO Auto-generated method stub
		cab_provider_name = providerName;
	}
	
	public String getCabProviderName()
	{
		return cab_provider_name;
	}

	public void setDriverAmount(String total) {
		if(total.indexOf(".") < 1)
		{
			total = total + ".00";
		}else if(total.indexOf(".00") < 1)
		{
			total = total + "0";
		}
		total = "$" + total;
