...
import com.smart.taxi.R.array;
import com.smart.taxi.R.drawable;
import com.smart.taxi.R.id;
import com.smart.taxi.R.layout;
import com.smart.taxi.R.string;
...
public class ContainerActivity extends BaseActivity {
    ...
    protected void onResume()
    {
    	...
    	{
    		try{
    			Log.e("score", bundle.getString("score"));
    		}catch(Exception ex){}
    	...
    	if(lastIndex == position && lastFragment instanceof TripRequestFragment && SplashActivity.isTripRequested)
    	{
	    	...
	    	case 0:
	    		if(SplashActivity.isTripRequested && SplashActivity.getTripNewDetails() != null)
	    		{
		    		...
		    		fragment = new FindARideActivity();
		    		tag = FindARideActivity.TAG;
	    		}
	    		break;
	    	
			case 2:
				fragment = new TripHistoryActivity();
				tag = TripHistoryActivity.TAG;
				break;
				
			case 3:
				fragment = new ProfileActivity();
				tag = ProfileActivity.TAG;
				break;
				
			case 4:
				fragment = new ChangeTipActivity();
				tag = ChangeTipActivity.TAG;
				break;
