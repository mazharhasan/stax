...
public final class APIConstants {
	...
	public static final String API_END_POINT = "http://api.smarttaxi.ca/services_v2/stax/user/api/";//"http://technyxsystems.com/demo/stax/user/api/";//"http://api.smarttaxi.ca/services/stax/user/api/";
